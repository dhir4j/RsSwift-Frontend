    ...
    <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 print:p-0 print:m-0">
      <Card className="shadow-xl print:shadow-none print:border-none">
        <CardHeader className="bg-muted/30 print:bg-transparent p-6 rounded-t-lg">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
            <div>
              <Image src="/images/rsswift_logo.png" alt={`${siteConfig.name} Logo`} width={180} height={45} className="object-contain mb-2 print:w-36" />
            ...
            <div className="text-left sm:text-right mt-4 sm:mt-0">
              ...
              <p className="text-sm text-muted-foreground">Due Date: {format(invoiceDate, 'dd MMM, yyyy')}</p>
        ...
        <CardContent className="p-6 space-y-4">
          ...
          <div>
             ...
             <p className="font-bold text-green-600">{shipment.status === "Pending Payment" ? "PENDING" : "PAID"}</p>
          </div>
      ...
      <style jsx global>{`
        @media print {
          ...
          div.max-w-4xl.mx-auto { max-width: 100% !important; margin: 0 !important; padding: 0 !important; }
          .print\\:shadow-none.print\\:border-none { width: 100% !important; height: 100% !important; border-radius: 0 !important; }
        }
