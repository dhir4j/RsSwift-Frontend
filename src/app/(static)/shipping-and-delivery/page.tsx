    ...
    <div className="space-y-8">
      <Card className="shadow-lg">
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <p>Thank you for choosing RS SWIFT COURIERS LLP. This policy details our shipping and delivery procedures to ensure you are fully informed about how we handle your shipments.</p>
          ...
          <p>We do not ship prohibited items as detailed in our Terms of Service. This includes hazardous materials, illegal substances, and other restricted goods. RS SWIFT COURIERS LLP reserves the right to refuse any shipment that violates our policies or the law.</p>
