    ...
    <div className="space-y-8">
      <Card className="shadow-lg">
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <p>This policy outlines the procedures for cancellations and refunds for services provided by RS SWIFT COURIERS LLP.</p>
          ...
          <p>RS SWIFT COURIERS LLP reserves the right to cancel any shipment for reasons including, but not limited to, non-availability of service to a destination, prohibited items in the package, or incorrect information provided by the user.</p>
