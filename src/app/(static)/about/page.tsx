  ...
  return (
    <div className="space-y-12">
      <section className="text-center">
        <h1 className="text-3xl sm:text-4xl font-headline font-bold text-primary mb-4">About SwiftShip</h1>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
        {[
          { icon: Lightbulb, title: "Innovation", description: "Constantly seeking new ways to improve our services and streamline your shipping experience." , dataAiHint: "bright idea"},
