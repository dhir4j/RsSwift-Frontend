    ...
    <div className="space-y-8">
      <Card className="shadow-lg">
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <p>Welcome to RS SWIFT COURIERS LLP ("SwiftShip"). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us.</p>
          
          <h2 className="text-xl font-semibold text-foreground pt-4">1. Information We Collect</h2>
          <p>When you register for an account on SwiftShip, we collect personal information you provide to us, such as your first name, last name, email address, and password. When you use our services to book a shipment, we collect details related to the shipment, including sender and receiver names, addresses, phone numbers, and package information. This information is transmitted to and stored on our secure servers to provide and manage your shipments.</p>
