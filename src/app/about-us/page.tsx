        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <div className="space-y-6">
              <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl font-headline">About RS SWIFT COURIERS</h1>
              <div className="space-y-4 text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                <p>
                  Welcome to RS SWIFT COURIERS, your most trusted partner for courier and logistics services across India. Founded with a vision to redefine the delivery experience, we are committed to providing fast, reliable, and secure shipping solutions for individuals and businesses alike.
                </p>
                <p>
                  Our journey began with a simple mission: to bridge distances by delivering packages with utmost care and efficiency. At RS SWIFT COURIERS, we leverage cutting-edge technology and a robust network to ensure that your parcels reach their destination on time, every time. Our real-time tracking system provides complete transparency, giving you peace of mind from pickup to delivery.
                </p>
                <p>
                ...
                <p>
                  Thank you for choosing RS SWIFT COURIERS. We look forward to serving you.
                </p>
              </div>
            </div>
          </div>
