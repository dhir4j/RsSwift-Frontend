          ...
          <div className="container px-4 md:px-6">
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                ...
                <p>Please read these Terms of Service ("Terms", "Terms of Service") carefully before using our website (the "Service") operated by RS SWIFT COURIERS ("us", "we", or "our").</p>
                ...
                <p>RS SWIFT COURIERS provides courier and logistics services. By placing an order through our website, you are offering to purchase a service on and subject to the following terms and conditions. All orders are subject to availability and confirmation of the order price.</p>

                <h2 className="text-2xl font-bold font-headline mt-6">3. User Obligations</h2>
                <p>You agree not to use the Service for any unlawful purpose or any purpose prohibited under this clause. You agree not to use the Service in any way that could damage the Service, the reputation of RS SWIFT COURIERS, or the general business of RS SWIFT COURIERS. You further agree not to use the Service to send any prohibited items as per Indian law and our company policy.</p>
