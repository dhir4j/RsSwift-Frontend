...
import { PackageSearch, Filter, CalendarDays, Search, ListOrdered, Loader2, Eye } from 'lucide-react';
    ...
    return shipments
      .filter(shipment => {
        ...
        const searchMatch = searchTerm === '' || 
                            ...
                            (shipment.sender_name && shipment.sender_name.toLowerCase().includes(searchLower)) ||
                            (shipment.receiver_name && shipment.receiver_name.toLowerCase().includes(searchLower));
                ...
                {filteredShipments.map((shipment) => (
                  <TableRow key={shipment.shipment_id_str}> 
                    ...
                    <TableCell className="text-right">
                      <Button asChild variant="outline" size="sm" disabled={!shipment.shipment_id_str}>
                        <Link href={`/dashboard/track-shipment?id=${shipment.shipment_id_str}`}>
