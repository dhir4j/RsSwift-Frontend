...
const testimonials = [
  {
    quote: "SwiftShip has been a game-changer for our business. Their express delivery is incredibly fast and reliable. We can always count on them.",
    author: "Rohan Sharma",
  ...
  {
    quote: "As a frequent shipper, I appreciate the professionalism and efficiency of SwiftShip. Their nationwide coverage is a huge plus.",
    author: "Amit Singh",
