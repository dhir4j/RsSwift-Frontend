...
import { mapApiShipmentToFrontend } from './shipment-context';

interface InvoiceContextType {
  displayInvoices: DisplayInvoice[]; 
  isLoading: boolean;
  fetchUserShipmentsForInvoices: () => Promise<void>;
  getDisplayInvoiceByShipmentId: (shipment_id_str: string) => Promise<DisplayInvoice | undefined>;
}
...
const transformShipmentToDisplayInvoice = (mappedShipment: Shipment): DisplayInvoice => {
  ...
  const shipmentId = mappedShipment.shipmentIdStr || mappedShipment.shipment_id_str;
